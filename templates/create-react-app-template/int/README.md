# create-react-app-template - Integration Stage

This is the **integration** version of the `create-react-app-template` template.
...
```bash
./scripts/promote-template.sh --template create-react-app-template --from int --to prod
```
