# my-lonely-template - Development Stage

This is the **development** version of the `my-lonely-template` template.
...
```bash
./scripts/promote-template.sh --template my-lonely-template --from dev --to int
```
