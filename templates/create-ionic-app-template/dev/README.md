# create-ionic-app-template - Development Stage

This is the **development** version of the `create-ionic-app-template` template.
...
```bash
./scripts/promote-template.sh --template create-ionic-app-template --from dev --to int
```
