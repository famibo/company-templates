# create-ionic-app-template - Integration Stage

This is the **integration** version of the `create-ionic-app-template` template.
...
```bash
./scripts/promote-template.sh --template create-ionic-app-template --from int --to prod
```
