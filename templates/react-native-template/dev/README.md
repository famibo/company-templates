# react-native-template - Development Stage

This is the **development** version of the `react-native-template` template.
...
```bash
./scripts/promote-template.sh --template react-native-template --from dev --to int
```
