# react-native-template - Integration Stage

This is the **integration** version of the `react-native-template` template.
...
```bash
./scripts/promote-template.sh --template react-native-template --from int --to prod
```
